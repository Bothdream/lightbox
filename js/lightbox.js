        ...
        action:function(){
            ...
            this.lightbox.click(function(){
                ...
                if(!_this_.config.isChange){
                    ...
                    $(this).clone(false).appendTo($("div.imglist").eq(0)).css({
                        width:w, //设置单张图片的属性
                        height:h,
                        position:'absolute',
                        top:"50%",
                    ...
                    var len = _this_.lightbox.size() + "00%";
                    //被点击的那张图片的索引和偏移量, 
                    //查找点击图片在原来图片集合中的索引：_this_.lightbox.index(self)
                    var offsetWidth = _this_.lightbox.index(self)*w;
                    ...
                    //左点击
                    var offset = _this_.lightbox.index(self);
